# -*- coding: utf-8 -*-
"""CK_NMT_FINAL_RNN+TRANS.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1WyTBwD5AlcDiPCGBDh5l0AdT9sie10kK
"""
...
class CONFIG:
    # version and outputs
    version = '-v228'
    root_output_dir = '/content/drive/MyDrive/cl-nmt-training-models/' # set the output directory
    is_forward = False # true means source to target training
    ...
    # data params
    dataset_name = 'amlan107/xyz' # test set + monlingual
    dev_val = 'amlan107/dv' # validation
    base_syn_name = 'amlan107/syn_0' #12k

    synthetic_dataset_name = 'amlan107/syn_0' # train 50k+12k
    synthetic_dataset_next = 'syn_true' + str(run_id) + '_SK_RNN_seed' + str(seed) # base_syn + monolingual -- SK suffix is used to distinguish the dataset from previous exp
    ...
    label_smoothing = 0.2 # trains 0.5 # rnn 0.2
    early_stoppings = 10
    keep_top_models = 10
...
# -*- coding: utf-8 -*-
# Original file is located at https://colab.research.google.com/drive/1YiIVVhjnXRWBHW9wNUdEIR2VMRfBlTnL
## model's and source training code https://github.com/bentrevett/pytorch-seq2seq/blob/master/3%20-%20Neural%20Machine%20Translation%20by%20Jointly%20Learning%20to%20Align%20and%20Translate.ipynb
## attention used is Luong attention https://arxiv.org/pdf/1508.04025.pdf
## Beam Search source code: https://github.com/budzianowski/PyTorch-Beam-Search-Decoding/blob/master/decode_beam.py

"""# Training version setup"""
...
#2 set training destination folder
...
!pip install transformers==4.36.2 evaluate sacrebleu sentencepiece sacremoses sh accelerate
!pip install -U datasets # Otherwise: NotImplementedError: Loading a dataset cached in a LocalFileSystem is not supported.
...
# sentence = 'কি করছ তুমি?'
# sentence = '𑄟𑄧𑄢𑄴 𑄖𑄬𑄎 𑄚𑄬𑄃𑄨.'

# print(TOKENIZER['target'].tokenize(sentence))
# print(TOKENIZER['target'](sentence))
...
"""# Model parameters and size check"""

# def count_parameters(model):
#     return sum(p.numel() for p in model.parameters() if p.requires_grad)

# print(f'The model has {count_parameters(MODEL['source']):,} trainable parameters')

# param_size = 0
# for param in MODEL['source'].parameters():
#     param_size += param.nelement() * param.element_size()
# buffer_size = 0
# for buffer in MODEL['source'].buffers():
...
# def test_with_generate(model, data_loader, tokenizer):
...
"""# Optimizers,  Schedulers, and Loss-function"""

############################################################### Model's helpers
## set proper scheduler like 'Attention is all you need' !!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -> then hyparameter optimize
# optimizer = dict()
# optimizer['source'] = AdamW(source2target_model.parameters(), lr=LEARNING_RATE)  # TODO: replace with torch.optim.AdamW ??
# optimizer['target'] = AdamW(target2source_model.parameters(), lr=LEARNING_RATE)  # TODO: replace with torch.optim.AdamW ??

# accelerator = Accelerator()
# model, optimizer, train_dataloader, eval_dataloader = accelerator.prepare(model, optimizer, train_dataloader, eval_dataloader)

# num_training_steps = NUM_TRAIN_STEPS # useless for now

# this hugginface linear scheduler is dependent on num_training_steps for calculating lr
# source2target_lr_scheduler = get_scheduler(
#     "linear",
#     optimizer=optimizer,
...
# scheduler_lambda = partial(lambda cur_step, warmup_steps, gamma : (cur_step/warmup_steps) if cur_step < warmup_steps else (1 / (1 + gamma*(cur_step - warmup_steps))), warmup_steps = NUM_WARMUP_STEPS, gamma = LR_GAMMA)
# source2target_lr_scheduler = optim.lr_scheduler.LambdaLR(optimizer, scheduler_lambda)

## custom learning rate scheduler
# source2target_lr_scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, 'max', 0.5, 3, verbose = True)

# ## constant lr
# lr_scheduler = dict()
# lr_scheduler['source'] = optim.lr_scheduler.LambdaLR(source2target_optimizer, lambda cur_step: 1.0)
# lr_scheduler['target'] = optim.lr_scheduler.LambdaLR(target2source_optimizer, lambda cur_step: 1.0)

# loss_fct = CrossEntropyLoss(label_smoothing = LABEL_SMOOTHING)

# print(f'Learning Rate: {LEARNING_RATE}')
# print(f'Label  Smoothing factor: {LABEL_SMOOTHING}')

"""# Post process method for score calculation"""

## tokenizer.batch_decode() auto cleans spaces before punctuations
# .replace(" .", ".")
# .replace(" ?", "?")
# .replace(" !", "!")
# .replace(" ,", ",")
...
# # select best model
# best_path = '/content/drive/MyDrive/cl-nmt-training-models/2023-09-29-v1/s-run0-epoch11.pt'
# checkpoint  = torch.load(best_path)
# best_model = checkpoint['model']
